...
IF OBJECT_ID ('SchemaUtilizador.procModPass', 'P') IS NOT NULL
	DROP proc SchemaUtilizador.procModPass;
GO
Create proc SchemaUtilizador.procModPass
			(@NuserID int, @passAntiga varchar, @passNova varchar)
as
Begin
...
IF OBJECT_ID ('SchemaProduto.procProdSeguidos', 'P') IS NOT NULL
	DROP proc SchemaProduto.procProdSeguidos;
GO
Create proc SchemaProduto.procProdSeguidos
			(@NuserID int)
as
Begin
	select*from Utilizador;
End
Go
IF OBJECT_ID ('SchemaProduto.procProdSeguidosUtilizador', 'P') IS NOT NULL
	DROP proc SchemaProduto.procProdSeguidosUtilizador;
GO
Create proc SchemaProduto.procProdSeguidosUtilizador
			(@NuserID int, @prodID int, @licitaValMax decimal)
as
Begin
	select*from Utilizador;
...
IF OBJECT_ID ('SchemaLicitacao.procLicitacoesUtilizador', 'P') IS NOT NULL
	DROP proc SchemaLicitacao.procLicitacoesUtilizador;
GO
Create proc SchemaLicitacao.procLicitacoesUtilizador
			(@NuserID int, @prodID int, @licitaValMax decimal)
as
Begin
	select*from Utilizador;
...
IF OBJECT_ID ('SchemaLicitacao.procVendaUtilizador', 'P') IS NOT NULL
	DROP proc SchemaLicitacao.procVendaUtilizador;
GO
Create proc SchemaLicitacao.procVendaUtilizador
			(@NuserID int, @prodID int, @licitaValMax decimal)
as
Begin
	select*from Utilizador;
...
IF OBJECT_ID ('SchemaLicitacao.procClassificacaoPendente', 'P') IS NOT NULL
	DROP proc SchemaLicitacao.procClassificacaoPendente;
GO
Create proc SchemaLicitacao.procClassificacaoPendente
			(@NuserID int, @prodID int, @licitaValMax decimal)
as
Begin
	select*from Utilizador;
...
IF OBJECT_ID ('SchemaLicitacao.procClassificacarCompra', 'P') IS NOT NULL
	DROP proc SchemaLicitacao.procClassificacarCompra;
GO
Create proc SchemaLicitacao.procClassificacarCompra
			(@NuserID int, @prodID int, @licitaValMax decimal)
as
Begin
	select*from Utilizador;
...
IF OBJECT_ID ('SchemaLicitacao.procUtilizadorMelhorClass', 'P') IS NOT NULL
	DROP proc SchemaLicitacao.procUtilizadorMelhorClass;
GO
Create proc SchemaLicitacao.procUtilizadorMelhorClass
			(@NuserID int, @prodID int, @licitaValMax decimal)
as
Begin
	select*from Utilizador;
...
IF OBJECT_ID ('SchemaLicitacao.procUtilizadorMelhorClassMes', 'P') IS NOT NULL
	DROP proc SchemaLicitacao.procUtilizadorMelhorClassMes;
GO
Create proc SchemaLicitacao.procUtilizadorMelhorClassMes
			(@NuserID int, @prodID int, @licitaValMax decimal)
as
Begin
	select*from Utilizador;
