...
INSERT INTO SchemaUtilizador.Utilizador([UtilizadorNome],[UtilizadorSenha],[UtilizadorEmail],[UtilizadorDataRegisto],[UtilizadorDataNascimento],[UtilizadorTelefone],[UtilizadorTipoUtilizadorID]) VALUES('André Gastão ','YN8sLG0juU6cMI8z','quam@vulputateposuerevulputate.org','2016-02-18','1982-03-19','961881123',3);
INSERT INTO SchemaUtilizador.Utilizador([UtilizadorNome],[UtilizadorSenha],[UtilizadorEmail],[UtilizadorDataRegisto],[UtilizadorDataNascimento],[UtilizadorTelefone],[UtilizadorTipoUtilizadorID]) VALUES('Rui Carvalho','YN8sLG0juU6cMI8z','quam@vulputateposuerevulputate.org','2016-02-18','1982-03-19','968881126',2);
---------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------
Go
INSERT INTO SchemaProduto.Produto([ProdutoNome],ProdutoDescricao,[ProdutoValorMinVenda],[ProdutoDataLimiteLeilao],[ProdutoUtilizadorID]) VALUES('Fusce Aliquet Magna Industries','dignissim lacus. Aliquam rutrum lorem ac risus. Morbi metus. Vivamus euismod urna. Nullam lobortis quam a felis ullamcorper viverra. Maecenas', 12.91,'2016-06-17',1)
INSERT INTO SchemaProduto.Produto([ProdutoNome],ProdutoDescricao,[ProdutoValorMinVenda],[ProdutoDataLimiteLeilao],[ProdutoUtilizadorID]) VALUES('Magna Industries','Donec egestas. Aliquam nec enim. Nunc ut erat. Sed nunc est, mollis non, cursus non, egestas a, dui. Cras pellentesque.',85.96,'2017-02-15',2)
INSERT INTO SchemaProduto.Produto([ProdutoNome],[ProdutoDescricao],[ProdutoValorMinVenda],[ProdutoDataLimiteLeilao],[ProdutoUtilizadorID]) VALUES('Cursus In Hendrerit PC','id enim. Curabitur massa. Vestibulum accumsan neque et nunc. Quisque ornare tortor at risus. Nunc ac sem ut dolor dapibus',39.45,'2016-05-21',3)
...
INSERT INTO SchemaProduto.Produto([ProdutoNome],[ProdutoDescricao],[ProdutoValorMinVenda],[ProdutoDataLimiteLeilao],[ProdutoUtilizadorID]) VALUES('Nulla Vulputate Dui PC','nunc id enim. Curabitur massa. Vestibulum accumsan neque et nunc. Quisque ornare tortor at risus. Nunc ac sem ut dolor',40.36,'2016-04-13',5)
INSERT INTO SchemaProduto.Produto([ProdutoNome],[ProdutoDescricao],[ProdutoValorMinVenda],[ProdutoDataLimiteLeilao],[ProdutoUtilizadorID]) VALUES('Commodo Hendrerit Donec Foundation','dui, semper et, lacinia vitae, sodales at, velit. Pellentesque ultricies dignissim lacus. Aliquam rutrum lorem ac risus. Morbi metus. Vivamus',19.35,'2016-06-16',3)
INSERT INTO SchemaProduto.Produto([ProdutoNome],[ProdutoDescricao],[ProdutoValorMinVenda],[ProdutoDataLimiteLeilao],[ProdutoUtilizadorID]) VALUES('Mauris Inc.','metus urna convallis erat, eget tincidunt dui augue eu tellus. Phasellus elit pede, malesuada vel, venenatis vel, faucibus id, libero.',74.51,'2017-08-23',2)
...
INSERT INTO SchemaUtilizador.Compra(CompraClassificacao,CompraLicitacaoID,CompraProdutoID) VALUES (4,9,5);
...
INSERT INTO SchemaUtilizador.Compra (CompraClassificacao,CompraLicitacaoID,CompraProdutoID) VALUES (5,17,12);
...
INSERT INTO SchemaUtilizador.Compra(CompraClassificacao,CompraLicitacaoID,CompraProdutoID) VALUES (3,11,12);
...
INSERT INTO SchemaUtilizador.Compra (CompraClassificacao,CompraLicitacaoID,CompraProdutoID) VALUES (4,3,7);
INSERT INTO SchemaUtilizador.Compra (CompraClassificacao,CompraLicitacaoID,CompraProdutoID) VALUES (NULL,14,13);
INSERT INTO SchemaUtilizador.Compra (CompraClassificacao,CompraLicitacaoID,CompraProdutoID) VALUES (1,16,8);
